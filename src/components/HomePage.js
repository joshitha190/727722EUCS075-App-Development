  ...
  return (
    <div className="home-page">
      ...
      <div class="hero-image">
        <img src="https://img.freepik.com/premium-vector/job-search-recruitment-head-hunting-social-network_126283-1315.jpg?size=626&ext=jpg&ga=GA1.2.498403158.1722160667&semt=ais_user"></img>
    </div>
      ...
      <div className="about-section">
        <h2>About Us</h2>
        <p>At Job Portal, we are committed to helping job seekers find the best job opportunities and employers find the best talent. With a vast network of companies and a wide range of job listings, we provide a platform that bridges the gap between job seekers and employers.</p>
      </div>
